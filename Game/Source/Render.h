...
public:
	...
	bool DrawTextureDX(SDL_Texture* texture, int x, int y, bool flip, const SDL_Rect* section = NULL, float speed = 1.0f, double angle = 0, int pivotX = INT_MAX, int pivotY = INT_MAX) const;
